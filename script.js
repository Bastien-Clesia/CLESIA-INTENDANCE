...
/* =========================================================
   REMPLACEMENT DES TEXTES — VERSION CORRIGÉE
   ========================================================= */

const originalTextElements = [];


/*
 * On mémorise également les éléments qui contiennent
 * plusieurs morceaux de texte.
 *
 * C'est important car certains paragraphes du HTML
 * sont écrits sur plusieurs lignes.
 */
function collectOriginalTextElements() {
    ...
    document.body.querySelectorAll("*").forEach(function (element) {
        ...
        /*
         * On cible les éléments qui ne contiennent
         * pas d'autre élément HTML.
         */
